<div class="modal fade" id="new-release{{ $detail->id }}">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success-subtle">
                <h5 class="modal-title">@lang('locale.release', ['suffix'=>''])</h5>
            </div>
                    ...
                    <div class="d-grid gap-3">
                        <div class="row">
                            ...
                            <div class="col-12 mt-3"> 
                                ...
                                <div class="form-floating">
                                    <select class="form-select" name="delivery" aria-label="@lang('locale.deliver', ['suffix'=>app()->getLocale() == 'en' ? 'y' : ''])" required>
                                        @foreach (['Cool AgriTransport', 'Tierce', 'Client'] as $item)
                                        <option value="{{ $item }}">{{ $item }}</option>
                                        @endforeach
                                    </select>
                                    <label for="deliveryId">@lang('locale.delivery', ['suffix'=>app()->getLocale() == 'en' ? 'y' : ''])</label>
                                </div> 
                            </div> 
                        </div> 
                    </div>
