...
toastTrigger2&&toastTrigger2.addEventListener("click",function() {
...
toastTrigger3&&toastTrigger3.addEventListener("click",function() {
...
toastTrigger4&&toastTrigger4.addEventListener("click",function() {
...
toastPlacement&&document.getElementById("selectToastPlacement").addEventListener("change",function(){
    toastPlacement.dataset.originalClass||(toastPlacement.dataset.originalClass=toastPlacement.className),toastPlacement.className=toastPlacement.dataset.originalClass+" "+this.value}),document.querySelectorAll(".bd-example .toast").forEach(function(t){
